...
PYBIND11_MODULE(easypbr, m) {
    ...
    .def("create_frustum_mesh", &Frame::create_frustum_mesh, py::arg("scale_multiplier") = 1.0, py::arg("show_texture")=true, py::arg("texture_max_size")=256,  py::arg("near_multiplier")=0.5,  py::arg("far_multiplier")=2.5 )
    ...
    .def("to_string", &Camera::to_string )
    ...
    .def_static("get_centroid",  &Scene::get_centroid, py::arg("use_mutex") = true )
    ...
    .def_readwrite("m_needs_sss", &VisOptions::m_needs_sss)
    ...
    .def("remove_unreferenced_verts", &Mesh::remove_unreferenced_verts )
