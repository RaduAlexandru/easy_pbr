...
public:
    ...
    std::shared_ptr<Mesh> create_frustum_mesh(float scale_multiplier=1.0, bool show_texture=true, const int texture_max_size=256, const float near_multiplier=0.5, const float far_multiplier=2.5) const;
